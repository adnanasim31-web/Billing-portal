...
export function PortalSidebar({ patientName }: { patientName: string }) {
  ...
  return (
    ...
    >
      <Link href="/portal" className="flex h-16 items-center gap-2.5 px-5">
      ...
      {!collapsed && (
        <div className="border-t border-sidebar-border px-5 py-4">
          <p className="text-[10px] uppercase tracking-wider text-sidebar-muted">Patient</p>
          <p className="mt-0.5 truncate text-sm font-medium">{patientName}</p>
        </div>
      )}
