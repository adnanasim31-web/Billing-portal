...
const HIGHLIGHTS = [
  {
    icon: FileText,
    title: "See every statement",
    body: "All your visits and charges from your provider's billing office, in one place.",
  },
  {
    icon: CreditCard,
    title: "Pay your balance online",
    body: "Check what you owe and make a payment whenever it's convenient for you.",
  },
  {
    icon: ShieldCheck,
    title: "Private & secure",
    body: "Your portal account only ever shows your own records - nothing else.",
  },
];
    ...
    <div className="relative hidden h-full flex-col justify-between overflow-hidden bg-sidebar p-12 text-sidebar-foreground lg:flex">
      ...
      <div className="relative z-10 flex items-center gap-2.5">
        ...
        <div className="leading-tight">
          ...
          <p className="text-[11px] uppercase tracking-wider text-sidebar-muted">Patient Portal</p>
        </div>
      </div>

      <div className="relative z-10 max-w-md space-y-6">
        <Kicker>Patient Portal</Kicker>
        <h1 className="text-3xl font-bold leading-tight tracking-tight">
          Your statements and balance, <span className="text-primary-400">in one place.</span>
        </h1>
